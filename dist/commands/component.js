...
function commandComponent(program) {
    var _this = this;
    program
        .command("component")
        .alias("c")
        ...
        return __generator(this, function (_a) {
            ...
            (0, default_config_1.writeFile)(path_1.default.join.apply(path_1.default, __spreadArray([process.cwd(), settings.sourceDir], paths, false)), fileName + ".".concat(settings.fileExtension), templates_1.ComponentTemplate[settings.component](fileName, settings.style), function (err) {
                if (err)
            ...
            if (settings.style !== "none") {
                (0, default_config_1.writeFile)(path_1.default.join.apply(path_1.default, __spreadArray([process.cwd(), settings.sourceDir], paths, false)), fileName + ".".concat(settings.style), "", function (err) {
                    if (err)
                        return console.error(err);
